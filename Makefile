.PHONY: help build dry-run-tests stage2-tests stage3-tests stage4-tests stage5-tests stage6-tests stage7-tests stage8-tests stage9-tests stage10-tests stage11-tests quality quality-fast \
...
help:
	...
	@echo "  make stage9-tests        - Run Stage 9 release report and notes schema tests"
	@echo "  make stage10-tests       - Run Stage 10 live smoke safety contract tests"
	@echo "  make stage11-tests       - Run Stage 11 release tag provenance contract tests"
